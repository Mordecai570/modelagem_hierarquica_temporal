...
if sec in "Objetivo":
    ...
    st.write("Os dados do consumo diário de energia foram extraídos do site oficial da ONS (Operador Nacional do Sistema Elétrico). O consumo é medido em MWmed, e é dividido por região (consumo diário no Norte, Nordeste, Sul e Sudeste-Centroeste). Foram extraídos os dados para todas as regiões desde 2017, contabiliazando 2922 dias de observações.")
    st.divider()
